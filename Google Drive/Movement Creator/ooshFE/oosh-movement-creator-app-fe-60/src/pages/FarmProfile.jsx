...
import { Leaf, MapPin, Users, Milk, ShoppingBag, Calendar } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <Card className="w-full bg-white bg-opacity-90 backdrop-blur-sm shadow-lg border-teal-200">
          ...
          <CardContent className="pt-6 space-y-6">
            ...
            <div>
              <h3 className="font-semibold text-lg text-teal-800 mb-2">Upcoming Events</h3>
              <div className="flex items-center text-teal-700">
                <Calendar className="h-5 w-5 text-teal-600 mr-2" />
                <span>Farm tour and permaculture workshop - Next Saturday</span>
              </div>
            </div>
